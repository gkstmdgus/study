...
import jpabook.jpasjop.domain.Address;
import jpabook.jpasjop.domain.Member;
import jpabook.jpasjop.domain.Order;
import jpabook.jpasjop.domain.OrderStatus;
import jpabook.jpasjop.domain.item.Book;
import jpabook.jpasjop.exception.NotEnoughStockException;
...
public class OrderServiceTest {
    ...
    private Member createMember() {
        ...
        member.setName("회원1");
        member.setAddress(new Address("서울", "강가", "132-123"));
        em.persist(member);
        return member;
    }
}