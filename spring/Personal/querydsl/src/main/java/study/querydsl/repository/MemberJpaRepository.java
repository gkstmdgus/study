...
public class MemberJpaRepository {
    ...
    // JPAQueryFactory를 Bean으로 등록해도 됨
    ...
    public List<MemberTeamDto> searchByBuilder(MemberCondition condition) {
    ...
    // where절 사용
    public List<MemberTeamDto> searchByWhere(MemberCondition condition) {
        return queryFactory
                .select(
                        new QMemberTeamDto(
                                member.id,
